...
<head>
    ...
    <title>Pencarian Nilai Berdasarkan Tanggal</title>
...
<body>
    ...
    <div class="container">
        <h2 align="center">Pencarian Nilai Berdasarkan Tanggal</h2>
        <?php if ($message): ?>
        ...
        <?php if (!empty($nilai_records)): ?>
            <h2 align="center">Hasil Pencarian Tanggal <?php echo htmlspecialchars($tanggal); ?></h2>
            <table>
                <tr>
                    <th>ID Nilai</th>
                    <th>NIM Mahasiswa</th>
        ...
        <?php elseif ($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
            <p>Tidak ada nilai yang ditemukan untuk tanggal yang diberikan.</p>
        <?php endif; ?>
    </div>
</body>
</html>
